...
public class Tal_simpleParser extends Parser {
	...
	// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:16:1: listephrases returns [String arbresort = \"\"] : t= phrase POINT ;
	public final String listephrases() throws RecognitionException {
		...
		Arbre p;
		try {
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:17:24: (t= phrase POINT )
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:18:17: t= phrase POINT
			{
	...
	// $ANTLR start "phrase"
	// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:23:1: phrase returns [Arbre phrase = new Arbre(\"PHRASE\")] : agnc= gn_c agva= gv ;
	public final Arbre phrase() throws RecognitionException {
		...
		try {
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:28:10: (agnc= gn_c agva= gv )
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:29:9: agnc= gn_c agva= gv
			{
	...
	// $ANTLR start "gn_c"
	// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:37:1: gn_c returns [Arbre gnc = new Arbre(\"GNC\")] : agn1= gn (c= CONJ agn2= gn )* ;
	public final Arbre gn_c() throws RecognitionException {
		...
		Arbre gn1, gn2;
		try {
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:38:31: (agn1= gn (c= CONJ agn2= gn )* )
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:39:17: agn1= gn (c= CONJ agn2= gn )*
			{
			...
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:44:17: (c= CONJ agn2= gn )*
			loop1:
			while (true) {
				int alt1=2;
				...
				switch (alt1) {
				case 1 :
					// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:44:18: c= CONJ agn2= gn
					{
	...
	// $ANTLR start "gn"
	// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:51:1: gn returns [Arbre legn = new Arbre(\"GN\")] : (d= DET n1= NOM (a= ADJ )? |n2= NOM );
	public final Arbre gn() throws RecognitionException {
		...
		try {
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:51:42: (d= DET n1= NOM (a= ADJ )? |n2= NOM )
			int alt3=2;
			...
			switch (alt3) {
				case 1 :
					// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:52:9: d= DET n1= NOM (a= ADJ )?
					{
					...
					// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:57:9: (a= ADJ )?
					int alt2=2;
					...
					switch (alt2) {
						case 1 :
							// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:57:10: a= ADJ
							{
					...
					break;
				case 2 :
					// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:61:11: n2= NOM
					{
	...
	// $ANTLR start "gv"
	// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:67:1: gv returns [Arbre legv = new Arbre(\"GV\")] : v= VERBE (agnc= gn_c )? ;
	public final Arbre gv() throws RecognitionException {
		...
		Arbre gnc;
		try {
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:68:26: (v= VERBE (agnc= gn_c )? )
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:69:9: v= VERBE (agnc= gn_c )?
			{
			v=(Token)match(input,VERBE,FOLLOW_VERBE_in_gv445); 

			                legv.ajouteFils(new Arbre("VERBE",v.getText()));
			        
			// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:73:9: (agnc= gn_c )?
			int alt4=2;
			...
			switch (alt4) {
				case 1 :
					// /home/quachmau/sandbox/lo17/correction/src/main/java/main/utilse_moodle/Tal_simple.g:73:10: agnc= gn_c
					{
